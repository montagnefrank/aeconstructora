...
<html lang="en-US" >
    <head>
        <?php require ("assets/scripts/headtag.php"); ?>
    </head>
    <body class="page-template-default page page-id-24405 wpb-js-composer js-comp-ver-5.2.1 vc_responsive">
        ...
        <div id="page" class="layout-fullwidth header-style-3"><a href="#page" class="scroll-top-button"></a>
            ...
            <div id="main" class="site-main">
                <div id="main-content" class="main-content">
                    ...
                    <?php require ("assets/secs/sliderhome.php"); ?>
                                ...
                                <div class="panel-center col-xs-12">
                                    <article id="post-24405" class="post-24405 page type-page status-publish hentry">
                                        <div class="entry-content post-content">
                                            <?php require ("assets/secs/portfolio.php"); ?>
                                            <div class="vc_row-full-width vc_clearfix"></div>
                                            <div class="vc_row-full-width-before"></div>
                                            <?php require ("assets/secs/about.php"); ?>
                                            <div class="vc_row-full-width vc_clearfix"></div>
                                            <div class="vc_row-full-width-before"></div>
                                            <?php require ("assets/secs/mvv.php"); ?>
                                            <div class="vc_row-full-width vc_clearfix"></div>
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <div class="title-h3"><span style="color: #111111;">
                                                                            <span class="light">SI EST&Aacute;S LISTO PARA ADQUIRIR TU INMUEBLE AL MEJOR PRECIO </span> &iexcl;LLAMA AHORA!</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="clearboth"></div>
                                                ...
                                                <div class="wpb_column vc_column_container vc_col-sm-6">
                                                    <div class="vc_column-inner ">
                                                        <div class="wpb_wrapper">
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <div class="title-h1"><span style="color: #00f4d4;">099 462 6610 <br /> 098 351 1702</span></div>
                                                                </div>
                                                            </div>
                                                            <div class="wpb_text_column wpb_content_element  vc_custom_1464014256658">
                                                                <div class="wpb_wrapper">
                                                                    <div class="title-h6" style="font-size: 14px;">&Aacute;ngel Rojas y Juan Le&oacute;n Mera.<br /> Quito, Ecuador<br /> <span style="color: #00f4d4;">ventas@aeconstructora.com</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-pull-9">
                            <div class="footer-site-info">AEConstructora 2018 &copy;  hecho por <a href="http://www.burtonservers.com" target="_self"> Burton Technology</a></div>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <?php require ("assets/scripts/customscripts.php"); ?>
